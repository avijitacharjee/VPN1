...
public class AdModFacebook {
    ...
    public static void buildAdBanner(Context context, RelativeLayout linearLayout, int i, final MyAdListener myAdListener) {
            ...
            AdView adView = new AdView(context, StaticData.FACEBOOK_BANNER, adSize);
    ...
    public static void buildAdFullScreen(Context context, final MyAdListener myAdListener) {
        StaticData.SHOW_INTERSTITIAL_COUNT++;
        if (StaticData.SHOW_INTERSTITIAL_COUNT%StaticData.SHOW_INTERTISIAL_DELAY==0) {

           final InterstitialAd interstitialAd = new InterstitialAd(context, StaticData.FACEBOOK_INTER);
